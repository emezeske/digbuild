...
void GameApplication::render()
{
    ...
    debug_info_window.set_engine_chunk_stats( renderer_.get_num_chunks_drawn(), world_.get_chunks().size(), renderer_.get_num_triangles_drawn(), renderer_.get_num_chunks_culled_by_occlusion() );
